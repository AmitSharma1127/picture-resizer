!(function(e, t) {
	...
	var o = (
		(t.prototype.wrapCallback = function(n) {
			var r = this;
			return function(e, t) {
				e ? r.reject(e) : r.resolve(t), "function" == typeof n &&
	...
	function t() {
		var n = this;
		(this.reject = function() {}), (this.resolve = function() {}), (this.promise = new Promise(
			function(e, t) {
		...
		(I.prototype.subscribe = function(e, t, n) {
			...
			void 0 ===
				(r = (function(e, t) {
					...
					? e
					: { next: e, error: t, complete: n }).next && (r.next = w), void 0 ===
				r.error && (r.error = w), void 0 === r.complete && (r.complete = w);
	...
	function I(e, t) {
		var n = this;
		(this.observers = []), (this.unsubscribes = []), (this.observerCount = 0), (this.task = Promise.resolve()), (this.finalized = !1), (this.onNoObservers = t), this.task
			.then(function() {
				e(n);
			})
			.catch(function(e) {
		...
		N = (
			...
			(C.prototype.clearInstance = function(e) {
				this.instancesDeferred.delete(
					(e = void 0 === e ? _ : e)
				), this.instancesOptions.delete(e), this.instances.delete(e);
			}),
			...
			(C.prototype.normalizeInstanceIdentifier = function(e) {
				return void 0 === e && (e = _), !this.component ||
	...
	var R,
		A = [];
	((z = R = R || {})[(z.DEBUG = 0)] =
		"DEBUG"), (z[(z.VERBOSE = 1)] = "VERBOSE"), (z[(z.INFO = 2)] = "INFO"), (z[(z.WARN = 3)] = "WARN"), (z[(z.ERROR = 4)] = "ERROR"), (z[(z.SILENT = 5)] = "SILENT");
	function P(e, t) {
	...
	function x(a, t) {
		for (var e = 0, n = A; e < n.length; e++)
			!(function(e) {
				var o = null;
				t && t.level && (o = k[t.level]), (e.userLogHandler =
					null === a
						? null
						: function(e, t) {
		...
		G = (
			...
			($.prototype.delete = function() {
				...
				return new Promise(function(e) {
					...
					.then(function() {
						return t.firebase_.INTERNAL.removeApp(t.name_), Promise.all(
				...
				return n.isInitialized() ||
					"EXPLICIT" !==
						(null === (e = n.getComponent()) || void 0 === e
							? void 0
							: e.instantiationMode) ||
					n.initialize(), n.getImmediate({ identifier: t });
			}),
	...
	function $(e, t, n) {
		var r = this;
		(this.firebase_ = n), (this.isDeleted_ = !1), (this.name_ = t.name), (this.automaticDataCollectionEnabled_ = t.automaticDataCollectionEnabled || !1), (this.options_ = h(void 0, e)), (this.container = new S(t.name)), this._addComponent(
			new O(
				"app",
				function() {
					return r;
	...
	), q.registerVersion(B, "0.6.30", Q), q.registerVersion("fire-js", "");
	return ee.registerVersion(
		"firebase",
		"8.10.0",
		"app"
	), (ee.SDK_VERSION = "8.10.0"), ee;
});
